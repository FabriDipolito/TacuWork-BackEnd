...
class ColaboradoresService:
    ...
    def create_colaborador(self, nombre, apellido, edad, hijos, zona_residencial, telefono, nivel_educativo, egresos, peal_id):
        col = self.colaboradores_repository.create_colaborador(nombre, apellido, edad, hijos, zona_residencial, telefono, nivel_educativo, egresos, peal_id)
    ...
    def update_colaborador_by_id(self, colaborador_id, nombre, apellido, edad, hijos, zona_residencial, telefono,
        ...
        updated_colaborador = self.colaboradores_repository.update_colaborador_by_id(
            ...
            peal_id,
            banco, sucursal, numero_cuenta, nombre_emergencia, telefono_emergencia, imagen
        )
        ...
        if updated_colaborador:
            return {
                ...
                "imagen": base64.b64encode(updated_colaborador[10]).decode('utf-8') if updated_colaborador[
                    10] else None,
